            ...
            if (request == null) {
                ...
                if (request.length() == 0) {
                    ...
                    try {
                        ...
                        builder.append("Content-Type: text/html; charset=utf-8\n");
                        builder.append("\n");
                        builder.append("Incorrect or Insufficient Arguments!\n");
                        builder.append("API is /multiply?num1=int&num2=int");
                    ...
                    org.json.JSONArray githubResponse = new JSONArray(json);
                    ...
                    for (int i = 0; i < githubResponse.length();i ++) {
                        ...
                        builder.append(githubResponse.getJSONObject(i).getJSONObject("owner").get("id") + " -> ");
